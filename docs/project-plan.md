...
사용자가 브라우저에서 다른 사용자와 기본 체스 대국을 진행하고, 서버가 모든 수와 게임 결과를 검증하며, 연결이 끊겨도 게임 상태를 복구할 수 있는 첫 번째 릴리스를 완성한다.
...
### Phase 4: React/TypeScript 사용자 경험

목표: 초보자도 게임 상태와 조작 방법을 이해할 수 있는 화면을 제공한다.
